...
places = {'Lolo Pass':(-114.58,46.635),
          ...
          'Thompson Falls':(-115.343611,47.596667),
          'Lewiston':(-117.02,46.41),
          'Great Falls':(-111.289167,47.491667),
          'Helena':(-112.026389,46.596389),
          }
...
states.boundary.plot(ax=ax,color='gray',lw=0.5)
